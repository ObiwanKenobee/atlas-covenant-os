...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Atlas Sanctum OS — A Digital Cathedral for Human Flourishing" },
      {
        name: "description",
        content:
          "An AI-native operating system for community flourishing, regenerative investment, lifelong learning, and covenant stewardship.",
      },
      { name: "author", content: "Atlas Sanctum" },
      {
        property: "og:title",
        content: "Atlas Sanctum OS — A Digital Cathedral for Human Flourishing",
      },
      {
        property: "og:description",
        content:
          "A living institution for stewardship, wisdom, and regenerative prosperity.",
      },
